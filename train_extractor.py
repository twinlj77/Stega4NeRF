...
# print(net)
# raise
dir = r"C:\Users\123\Desktop\Stega4NeRF\data\train_secret-view"
fils = os.listdir(dir)
...
# 生成秘密
if os.path.exists("secret.pt"):
    secret = torch.load("secret.pt")
else:
    secret_shape = (1, D, 400, 400)
...
X_train = torch.zeros(size=(1, 3, 400, 400))
y_train = torch.zeros(size=(1, D * 400 * 400))
...
for epoch in range(epochs):
    ...
    if decoder_acc.item() == 1 and bpp == 1:
        ...
        print(f"Train acc=1 and Train bpp=1 achieved at epoch {epoch + 1}")
